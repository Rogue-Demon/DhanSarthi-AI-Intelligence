...
const InvestmentGuide = lazy(() => import('@/pages/Investments/Guide/InvestmentGuide'))
...
// Lazy loading Secure Financial Intelligence (isolated page)
const SecureFinancialIntelligence = lazy(
  () => import('@/pages/SecureFinancialIntelligence/SecureFinancialIntelligence')
)
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: 'secure-fi/:token',
        element: <LazyLoader component={SecureFinancialIntelligence} />,
      },
      {
        path: '',
        element: (
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: 'guide',
                element: <LazyLoader component={InvestmentGuide} />,
              },
              {
                path: 'portfolio',
