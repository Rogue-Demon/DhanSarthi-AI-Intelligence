...
class EntityExtractor:
    ...
    ENTITY_PATTERNS = [
        ...
        (r"\b(gold)\b", EntityCategory.COMMODITY, "Gold"),
        (r"\b(silver)\b", EntityCategory.COMMODITY, "Silver"),
        (r"\b(platinum)\b", EntityCategory.COMMODITY, "Platinum"),
        (r"\b(crude|crude oil|oil)\b", EntityCategory.COMMODITY, "Crude Oil"),
        (r"\b(reliance|reliance industries)\b", EntityCategory.STOCK, "Reliance Industries"),
        (r"\b(tcs|tata consultancy services)\b", EntityCategory.STOCK, "TCS"),
        (r"\b(infosys|infy)\b", EntityCategory.STOCK, "Infosys"),
        (r"\b(hdfc|hdfc bank)\b", EntityCategory.STOCK, "HDFC Bank"),
        (r"\b(wipro)\b", EntityCategory.STOCK, "Wipro"),
        (r"\b(icici|icici bank)\b", EntityCategory.STOCK, "ICICI Bank"),
        (r"\b(sbi|state bank of india)\b", EntityCategory.STOCK, "SBI"),
