      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="clay-surface bg-card p-5 border border-white/60 dark:border-white/5 rounded-2xl flex flex-col gap-3 shadow-xs">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-[10px] font-bold text-text-muted">
              Select how the AI financial advisor communicates with you.
            </span>
          </div>
        ...
        <div className="clay-surface bg-card p-5 border border-white/60 dark:border-white/5 rounded-2xl flex flex-col gap-3 shadow-xs">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-[10px] font-bold text-text-muted">
              Language used for financial advice and reports.
            </span>
          </div>
          <div className="grid grid-cols-3 gap-2 pt-1">
        ...
        <div className="clay-surface bg-card p-5 border border-white/60 dark:border-white/5 rounded-2xl flex flex-col gap-3 shadow-xs">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-[10px] font-bold text-text-muted">
              Choose between bullet points or step-by-step financial explanations.
            </span>
          </div>
        ...
        <div className="clay-surface bg-card p-5 border border-white/60 dark:border-white/5 rounded-2xl flex flex-col gap-4 shadow-xs">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-[10px] font-bold text-text-muted">
              Manage conversation history and export local AI logs.
            </span>
          </div>
