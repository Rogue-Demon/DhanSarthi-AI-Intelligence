...
class Settings(BaseSettings):
    ...
    marketstack_api_key: str | None = Field(default=None, validation_alias="MARKETSTACK_API_KEY")
    investment_guide_enabled: bool = Field(default=True, validation_alias="INVESTMENT_GUIDE_ENABLED")
    investment_cache_ttl_seconds: int = Field(default=300, validation_alias="INVESTMENT_CACHE_TTL_SECONDS")
    investment_max_symbols: int = Field(default=50, validation_alias="INVESTMENT_MAX_SYMBOLS")
