...
export const investmentsConfig = {
  [PROFILES.STUDENT]: {
    focusTabs: ['guide', 'portfolio', 'sip', 'gold', 'ppf'], // Active navigation tabs from config
    summary: {
      totalValue: '₹16,950',
      todayChange: '+₹150',
    ...
    sip: [
      {
        name: 'Micro Nifty SIP',
        amount: '₹200/mo',
        nextDate: '10th Aug',
        expectedVal: '₹14,500',
        progress: '32%',
        reminder: 'Auto-Debit On',
      },
    ],
    gold: [
      {
        type: 'Digital Sovereign Gold',
        qty: '1.5 Grams',
        value: '₹10,500',
        date: '05th Jul 2026',
        growth: '+4.5%',
    ...
    ppf: [
      {
        summary: 'State Bank PPF Account',
        balance: '₹6,450',
        contribution: '₹500/yr',
        interest: '7.1%',
        maturity: '2041',
  ...
  [PROFILES.PROFESSIONAL]: {
    ...
    sip: [
      {
        ...
        amount: '₹10,000/mo',
        nextDate: '05th Aug',
        expectedVal: '₹1,40,400',
        progress: '45%',
        reminder: 'Auto-Debit On',
      },
      {
        name: 'ICICI Bluechip SIP',
        amount: '₹5,000/mo',
        nextDate: '05th Aug',
        expectedVal: '₹1,09,200',
        progress: '35%',
        reminder: 'Auto-Debit On',
      },
    ],
    ...
    ppf: [
      {
        summary: 'ICICI Bank PPF Account',
        balance: '₹31,200',
    ...
    insights: [
      {
        text: 'Your portfolio has a high equity allocation. Consider shifting 10% to debt.',
        type: 'warning',
      },
      {
        text: 'Emergency fund coverage is at 5 months of opex. Goal nearly complete.',
        type: 'positive',
      },
    ],
  },
  [PROFILES.BUSINESS]: {
    focusTabs: ['guide', 'portfolio', 'bonds', 'gold'], // Focus: Corporate reserve portfolios, liquid gold, commercial bonds
    summary: {
      totalValue: '₹6,45,000',
      todayChange: '+₹8,500',
    ...
    insights: [
      {
        text: 'Portfolio risk is low. Cash flows are backed by government AAA debt paper.',
        type: 'positive',
      },
