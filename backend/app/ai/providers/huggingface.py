    ...
    async def generate_stream(
        ...
        **kwargs: Any,
        ...
        if "System Instructions:" in prompt:
            ...
            sys_part = parts[1].split("\n\n", 1) if len(parts) > 1 else [parts[0], ""]
            sys_content = "System Instructions:\n" + sys_part[0]
            user_content = sys_part[1] if len(sys_part) > 1 and sys_part[1].strip() else prompt
            messages = [
